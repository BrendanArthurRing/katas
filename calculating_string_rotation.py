...
For Swift, your function should return an Int?. 
So rather than returning -1 when the second string 
isn't a valid rotation of the first, return nil.
...
# Link
# http://www.codewars.com/kata/5596f6e9529e9ab6fb000014/train/python