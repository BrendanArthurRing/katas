# https://www.codewars.com/kata/how-many-stairs-will-suzuki-climb-in-20-years/train/python
...
# This was the best practice, interesting the square brackets are not needed, and also the order of operations is ok for * 20 being just tacked on the end.
